...
export const demoDogs: Dog[] = [
  {
    ...
    color: 'Lilac tri',
    bio: 'A renowned lilac tri stud celebrated for his heavy bone structure, large head and rare coat. A pillar of the Mako Kennel color program.',
    studFee: 'Inquire',
    featured: true,
    heroImage: img('002'),
  ...
  },
  {
    ...
    name: 'Mako\'s Siberia',
    color: 'All-white',
    bio: 'Our famous "white panther" — a striking all-white XL American Bully female and the face of Mako Kennel. Exceptional structure, a calm temperament and a rare coat.',
    featured: true,
    heroImage: img('005'),
  ...
  },
  {
    ...
    bio: 'A foundation chocolate merle dam known for heavy bone and for producing rare coat colors — including our white panther, Siberia.',
    featured: true,
    heroImage: img('061'),
    gallery: [img('046')],
    sortOrder: 3,
...
export const demoLitters: Litter[] = [
  {
    ...
    description: 'A premium pairing of Moncler with our chocolate merle dam Euphoria — pregnancy confirmed. Outstanding bone and rare colors expected.',
    heroImage: img('019'),
